...
CONFIG: Dict = {
    ...
    "risk_aversion": 2.5,   # δ ≈ E[R_m-R_f]/σ_m² with S≈0.35, σ≈15%
...
def main() -> BLResult:
    ...
    eq_table.to_csv(os.path.join(CONFIG["results_dir"], "equilibrium_vs_posterior.csv"),
                    index=False)
    ...
    weights_table.to_csv(os.path.join(CONFIG["results_dir"], "optimal_weights.csv"),
                         index=False)
    ...
    alloc.to_csv(os.path.join(CONFIG["results_dir"], "portfolio_allocation.csv"),
                 index=False)
    ...
    metrics_df.to_csv(os.path.join(CONFIG["results_dir"], "portfolio_metrics.csv"),
                      index=False)
    ...
    sens.to_csv(os.path.join(CONFIG["results_dir"], "sensitivity_weights.csv"),
                index=False)
    ...
    plot_weights(weights_chart_df,
                 os.path.join(CONFIG["results_dir"], "bl_weights_chart.png"))
    ...
    plot_efficient_frontier(
        ...
        os.path.join(CONFIG["results_dir"], "efficient_frontier.png"),
    )
